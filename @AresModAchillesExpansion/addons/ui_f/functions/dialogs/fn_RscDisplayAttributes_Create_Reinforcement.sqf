...
switch (_mode) do
{
	...
	case "0":
	{
		...
		if (_avaiable_faction_names isEqualTo []) exitWith {};
	...
	case "1":
	{
		...
		if (_avaiable_vehicle_category_names isEqualTo []) exitWith {};
	...
	case "2":
	{
		...
		if (_avaiable_vehicle_names isEqualTo []) exitWith {};
	...
	case "3":
	{
		...
		if (_avaiable_vehicle_classes isEqualTo []) exitWith {};
