...
#define VALID_CATEGORIES_HELICOPTERS 			[getText (configfile >> "CfgEditorSubcategories" >> "EdSubcat_Helicopters" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "rhs_EdSubcat_helicopter" >> "displayName")]
#define VALID_CATEGORIES_PLANES 				[getText (configfile >> "CfgEditorSubcategories" >> "EdSubcat_Planes" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "rhs_EdSubcat_aircraft" >> "displayName")]
#define VALID_CARGO_CATEGORIES 					[getText (configfile >> "CfgEditorSubcategories" >> "EdSubcat_Cars" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "EdSubcat_APCs" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "EdSubcat_Ships" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "rhs_EdSubcat_apc" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "rhs_EdSubcat_ifv" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "rhs_EdSubcat_truck" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "rhs_EdSubcat_car" >> "displayName"), getText (configfile >> "CfgEditorSubcategories" >> "rhs_EdSubcat_mrap" >> "displayName")]
