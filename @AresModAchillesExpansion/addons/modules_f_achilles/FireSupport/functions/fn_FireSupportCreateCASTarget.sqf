...
_targetPhoneticName = [Ares_CASTargetCount] call Ares_fnc_GetPhoneticName;
_target_name = format [localize "STR_CAS_X", _targetPhoneticName];
_dialogResult = 
[
	localize "STR_CREATE_CAS_TARGET",
	[
