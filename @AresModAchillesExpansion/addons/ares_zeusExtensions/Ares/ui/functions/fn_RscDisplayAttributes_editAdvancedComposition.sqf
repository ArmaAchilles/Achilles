...
switch (_mode) do
{
	case "LOADED":
	{
		...
		_ok_ctrl ctrlAddEventHandler ["ButtonClick", "[""OK_BUTTON""] call Ares_fnc_RscDisplayAttributes_editAdvancedComposition"];
		...
		[0,_category_ctrl,_last_choice] call Ares_fnc_RscDisplayAttributes_editAdvancedComposition;
	};
	case "0":
	{
