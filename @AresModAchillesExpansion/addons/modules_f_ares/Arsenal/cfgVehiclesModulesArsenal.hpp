...
{
	scopeCurator = 2;
	displayName = "$STR_AMAE_ADD_FILTERED";
...
{
	scopeCurator = 2;
	displayName = "$STR_AMAE_PASTE_N_REPLACE";
...
{
	scopeCurator = 2;
	displayName = "$STR_AMAE_PASTE_N_COMBINE";
...
{
	scopeCurator = 2;
	displayName = "$STR_AMAE_CREATE_BASIC_NATO";
...
{
	scopeCurator = 2;
	displayName = "$STR_AMAE_CREATE_BASIC_CSAT";
...
{
	scopeCurator = 2;
	displayName = "$STR_AMAE_CREATE_BASIC_AAF";
...
{
	scopeCurator = 2;
	displayName = "$STR_AMAE_CREATE_BASIC_GUERILLA";
