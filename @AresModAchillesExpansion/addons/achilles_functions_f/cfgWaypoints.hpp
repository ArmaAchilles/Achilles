...
class cfgWaypoints
{
	class Achilles
	{
		...
		class Fastroping
		{
			...
			file = "\achilles\functions_f\scripts\fn_wpFastrope.sqf";
		...
		class Land
		{
			...
			file = "\achilles\functions_f\scripts\fn_wpLand.sqf";
			icon = "\achilles\data_f\icons\icon_position.paa";
		};
		class Paradrop
		{
			...
			file = "\achilles\functions_f\scripts\fn_wpParadrop.sqf";
		...
		class SearchBuilding
		{
			...
			file = "\achilles\functions_f\scripts\fn_wpSearchBuilding.sqf";
			icon = "\achilles\data_f\icons\icon_position.paa";
		};
	};
};