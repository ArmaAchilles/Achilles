...
tooltip = "Ares Mod - Achilles Expansion (1.0.1)";
tooltipOwned = "Ares Mod - Achilles Expansion Owned";
actionName = "Website";
action = "https://github.com/ArmaAchilles/AresModAchillesExpansion";
overview = "<t color='#d1111c'>Ares Mod - Achilles Expansion</t>, better known as Achilles, is a gameplay modification for Arma 3. It expands the Zeus real-time editor with many new additions as well as provides bug fixes.<br /><br /><t color='#d1111c'>Ares Mod - Achilles Expansion</t> started as an expansion to Ares mod, which was created by Anton Struyk. Achilles became the de facto successor to Ares at the point the latter was no longer updated. Achilles has already grown into a splendid project, but new additions are still to come!";
overviewPicture = "\achilles\data_f_achilles\pictures\Achilles_Icon_005.paa";
overviewText = "Ares Mod - Achilles Expansion (1.0.1)";
